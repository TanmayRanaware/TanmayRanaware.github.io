...
export function Contact({ email, location }: Props) {
  return (
    <div className="space-y-6">
      {/* Top Row - Email and Location in one line */}
      ...
      {/* Bottom Row - Message Card in rectangle */}
      <div className="group relative bg-gradient-to-br from-gray-800/20 to-gray-900/20 backdrop-blur-sm border border-gray-400/30 rounded-lg p-6 hover:border-gray-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-gray-500/10">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-500 hover:to-purple-500 transition-all duration-200 text-sm font-medium whitespace-nowrap"
            >
